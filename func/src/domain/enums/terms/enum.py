...
class TermsFileType(Enum):
    ...
    TERM_CUSTOMER_RELATIONSHIP_SUMMARY_DL_PT = "term_customer_relationship_summary_dl_pt"
    TERM_CUSTOMER_RELATIONSHIP_SUMMARY_DL_US = "term_customer_relationship_summary_dl_us"
